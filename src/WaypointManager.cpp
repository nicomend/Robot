...
using namespace std;
WaypointManager::WaypointManager(vector<GridCell> path, double gridResolution, double mapResolution)
{
	int oldyaw = -999;
	int counter = 0;
...
// Creating way point every "num_of_GridCells" item on the path
//void WaypointManager::buildWaypointVector(int numberOfGridCells)
//{
//	Waypoint waypoint;
//	int oldyaw = -999;
